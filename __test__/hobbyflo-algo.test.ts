...
import { HobbyfloAlgoClient } from '../contracts/clients/HobbyfloAlgoClient';

const fixture = algorandFixture();

let appClient: HobbyfloAlgoClient;

describe('HobbyfloAlgo', () => {
  ...
  beforeAll(async () => {
    ...
    appClient = new HobbyfloAlgoClient(
      {
        sender: testAccount,
        resolveBy: 'id',
        id: 0,
